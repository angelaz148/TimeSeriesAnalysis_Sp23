...
> Answer: Solar energy consumption looks like it has an increasing exponential trend. The random component of solar energy consumption is not random; there appears to be some seasonality in it. Starting a few years before 2010, wind energy consumption has an increasing linear trend. The random component of wind energy consumption looks like it could be random. 
...
> Answer: When using the multiplicative seasonal component, the random component flips to having more randomness during the earlier years of the time series, rather than the later years of the series. 
